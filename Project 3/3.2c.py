...
plt.ylabel('Potential energy (V)', fontsize = 18)
ax.plot(timelistA,VlistT1,'tab:blue',label = 'T = 1')
ax.plot(timelistA,VlistT02,'tab:cyan',label = 'T = 0.2')
ax.tick_params(axis='both', which='major', labelsize=14)
plt.title('Fluctuation in potential energy (V)', fontsize = 18)
